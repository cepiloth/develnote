...
int do_list(unzFile uf)
{
    ...
    for (i=0;i<gi.number_entry;i++)
    {
		...
		int code = do_extract_onefile(uf, filename_inzip, (int)1, 1, NULL);
		
		if (code == UNZ_CRCERROR) {
			printf("UNZ_CRCERROR \n");
		}
...
#            endif
	...
	opt_do_extract_withoutpath = opt_overwrite = 1;
    if (opt_do_list==1)
